...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->output->Font = (gcnew System::Drawing::Font(L"Century Gothic", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(162)));
			this->output->Location = System::Drawing::Point(16, 146);
			this->output->Name = L"output";
			this->output->ReadOnly = true;
			this->output->Size = System::Drawing::Size(620, 310);
			...
			this->panel1->Size = System::Drawing::Size(97, 530);
			...
			this->standart_panel->Location = System::Drawing::Point(100, 0);
			...
			this->cnf_format_panel->Location = System::Drawing::Point(100, 0);
			...
			this->bilgi_panel->Location = System::Drawing::Point(100, 0);
			...
			this->ClientSize = System::Drawing::Size(751, 529);
...
#pragma endregion
	private: System::Void solve_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		std::regex full_input_regex(R"(^(\(\s*x\d+(')?(\s*\+\s*x\d+(')?)*\s*\)\.)*\(\s*x\d+(')?(\s*\+\s*x\d+(')?)*\s*\)$)");

		if (!std::regex_match(input, full_input_regex)) {
			output->Clear();
			output->AppendText("Hatalý veya eksik format girildi.\n");
			return;
		}
